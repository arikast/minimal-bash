...
ln -snf $BASH_MINIMAL_DIR/.vimrc $HOME/.vimrc
ln -snf $BASH_MINIMAL_DIR/.vim/plugin/bash-minimal.vim $HOME/.vim/plugin/
ln -snf $BASH_MINIMAL_DIR/.vim/plugin/easytabs.vim $HOME/.vim/plugin/
